<!--Ноутбук Lenovo G50-30 (80G001T3UA)-->
<script type="text/javascript">
/*Масив картинок*/
var photo = ['record_567612092.jpg', 
			'record_567612467.jpg'];
...
window.onload = function(){
	...
	imgFirst.src = 'pages/lenovo_g50_30_80g001t3ua/img/'+photo[index];
	imgFirst.width = 430;
	...
	for(var i = 0; i < photo.length; i++){
		...
		img.src = 'pages/lenovo_g50_30_80g001t3ua/img/'+photo[i];
		img.width = 100;
...
<?php
	$title_cat = '80G001T3UA';//змінна для вибору даних з таблиці store_catalog
...
<div id="right_for_pages">
	...
	<p>Екран 15.6" (1366x768) HD LED, глянцевий / Intel Pentium N3540 (2.16-2.66 ГГц) / RAM 4 ГБ / HDD 1 ТБ / Nvidia GeForce GT 820M, 1 ГБ / Без ОД / LAN / Wi-Fi / Bluetooth / веб-камера / DOS / 2.5 кг / черный</p>
...
<div id="main_for_pages">
	...
	<div>
		...
		<div>
			...
			<div class="label_for_right_box">Чотирьохядерний Intel Pentium N3540 (2.16 - 2.66 ГГц)</div>
		</div>
		<div>
			<div class="label_for_left_box">Оперативна пам`ять</div>
			<div class="label_for_right_box">4 ГБ DDR3L</div>
		</div>
		<div>
		...
		<div>
			...
			<div class="label_for_right_box">15.6" (1366x768) HD LED, глянцевий</div>
		</div>
		<div>
			<div class="label_for_left_box">Графічний адаптер</div>
			<div class="label_for_right_box">Дискретний, Nvidia GeForce GT 820M, 1 ГБ</div>
		</div>
		<div>
		...
		<div>
			...
			<div class="label_for_right_box">720p HD</div>
		</div>
		<div>
		...
		<div>
			...
			<div class="label_for_right_box">Вбудований мікрофон<br>Dolby Advanced Audio v2</div>
		</div>
		<div>
			<div class="label_for_left_box">Комплектація</div>
			<div class="label_for_right_box">Ноутбук<br>Батарея<br>Адаптер живлення<br>Документація</div>
		</div>
		<div>
...
<div>
<?php
define('DB_NAME_FOR_COMMENTS', 'lenovo_g50_30_80g001t3ua.db');//ім'я бази даних
